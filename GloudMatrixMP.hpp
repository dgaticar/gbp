...
bit_vector Baux2, bp, bopen,bp2,hoja, undis,unndis,unnsub,reldis,relndis,relnsub,bp2H,mapbarato,bp2maped;
...
bit_vector::select_1_type b_select, b2_select,bopen_select,reldis_select,relndis_select,relnsub_select,undis_select,unndis_select,unnsub_select,bp2maped_select;
